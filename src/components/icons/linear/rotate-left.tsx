...
export function RotateLeftLinearIcon({ size = 24, width, height, ...props }: IconSvgProps) {
  return (
    <svg
      aria-hidden="true"
      fill="none"
    ...
    >
      ...
      <path d="M7.87012 5.32007L11.2401 7.78007" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
    </svg>
  );
}
