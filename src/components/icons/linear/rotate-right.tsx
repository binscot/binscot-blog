...
export function RotateRightLinearIcon({ size = 24, width, height, ...props }: IconSvgProps) {
  return (
    <svg
      aria-hidden="true"
      fill="none"
    ...
    >
      ...
      <path d="M16.13 5.32007L12.76 7.78007" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
    </svg>
  );
}
