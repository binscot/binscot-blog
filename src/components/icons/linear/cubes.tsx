...
export function CubesLinearIcon({ size = 24, width, height, ...props }: IconSvgProps) {
  return (
    <svg
      aria-hidden="true"
      fill="none"
    ...
    >
      <path
        ...
        strokeWidth="1.5"
      />
      <path d="M2 9C2 5.13 5.13 2 9 2L7.95 3.75" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
      <path
