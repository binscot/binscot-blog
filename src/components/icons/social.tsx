...
const NpmIcon: React.FC<IconSvgProps> = ({ width = '2em', height = '2em', ...props }) => {
  return (
    <svg
      aria-hidden="true"
      fill="currentColor"
...
const NpmSmallIcon: React.FC<IconSvgProps> = ({ width = '2em', height = '2em', ...props }) => {
  return (
    <svg
      fill="currentColor"
      focusable="false"
...
const BunIcon: React.FC<IconSvgProps> = ({ width = '1em', height = '1em', ...props }) => {
  return (
    <svg aria-hidden="true" height={height} viewBox="0 0 32 32" width={width} {...props}>
      ...
      <path d="M11.43 18.11a2 2 0 1 0-2-2.05a2.05 2.05 0 0 0 2 2.05m9.2 0a2 2 0 1 0-2-2.05a2 2 0 0 0 2 2.05" fillRule="evenodd" />
      <path
